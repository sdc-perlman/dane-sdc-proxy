...
// export const SlideNav = ({ photos, activeSlide = 0, handleSetSlide }) => {
//     let offset = 0;
...
//                     {photos.map((photo, i) => (
//                         <NavImageWrapper onClick={() => handleSetSlide(i)} key={photo.id} active={i === activeSlide}>
...
// export const SlidesTrack = ({ photos, activeSlide }) => (
...
// export const SlideNext = ({ handleClick }) => (
